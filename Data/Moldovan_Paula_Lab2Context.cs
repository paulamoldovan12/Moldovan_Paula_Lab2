...
namespace Moldovan_Paula_Lab2.Data
{
    public class Moldovan_Paula_Lab2Context : DbContext
    {
        ...
        public DbSet<Moldovan_Paula_Lab2.Models.Author> Author { get; set; } = default!;
        public DbSet<Moldovan_Paula_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Moldovan_Paula_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Moldovan_Paula_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
